...
if __name__ == "__main__":
    ...
    file_path = "./checkpoints/LSTM_NO_EMBEDDING_15es_20seqlen_01lr_v8-epoch{epoch:03d}-words%d-sequence%d-minfreq%d-" \
    ...
    tf.saved_model.save(model, 'LSTM_NO_EMBEDDING_15es_20seqlen_v8')